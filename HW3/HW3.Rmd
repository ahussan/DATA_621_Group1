...
we will compare various metrics for all six models. We calculate all models’ confusion matrix, accuracy, classification error rate, precision, sensitivity, specificity, F1 score, and AUC.  
